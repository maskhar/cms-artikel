-- Migration: Add RLS policies for automation API access (FIXED)
-- File: 202609100015_add_automation_api_rls_policies_fixed.sql
...
WITH CHECK (
  ...
  EXISTS (
    ...
    INNER JOIN artikel.user_roles ur ON ur.site_id = a.site_id
